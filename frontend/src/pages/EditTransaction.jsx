...
const fetchTransaction = async () => {
  try {
    ...
    const transaction = response?.transaction || response?.data || response;
    ...
    if (transaction.userId && currentUser?.id && transaction.userId !== currentUser.id) {
      toast.error('Access denied: You can only edit your own transactions');
    ...
    <div className="min-h-screen bg-slate-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Edit Transaction</h1>
          <p className="text-slate-400">Update your transaction details.</p>
        </div>
